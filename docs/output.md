...
[minimap2](https://github.com/lh3/minimap2) is a versatile sequence alignment program; in Sarek it is used with the short-read genomic preset (`-x sr`). The aligned reads are coordinate-sorted (or name-sorted if [`GATK MarkDuplicatesSpark`](https://gatk.broadinstitute.org/hc/en-us/articles/5358833264411-MarkDuplicatesSpark) is used for duplicate marking) with [samtools](https://www.htslib.org/doc/samtools.html).
...
- `minimap2/`
  - Index (`.mmi`) corresponding to the [minimap2](https://github.com/lh3/minimap2) aligner
- `dbsnp/`
